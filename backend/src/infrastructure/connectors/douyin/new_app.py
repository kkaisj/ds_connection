...
from infrastructure.connectors.collect_instructions.douyin.new_app_collect import NewAppCollectInstruction
from infrastructure.connectors.login_instructions.douyin.new_app_login import NewAppLoginInstruction


class NewAppAdapter(BaseWebDataAdapter):
    """应用适配器编排骨架。"""

    adapter_key = "douyin.new_app"
