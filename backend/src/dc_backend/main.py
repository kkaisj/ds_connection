...
from dc_backend.config.settings import settings
from dc_backend.presentation.http.routers import (
    accounts,
    dashboard,
    executions,
    marketplace,
...
if __name__ == "__main__":
    ...
    uvicorn.run("dc_backend.main:app", host="0.0.0.0", port=8000, reload=True)
